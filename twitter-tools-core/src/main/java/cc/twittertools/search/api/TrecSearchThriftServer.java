...
public class TrecSearchThriftServer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    serverArgs.processor(searchProcessor);
    serverArgs.selectorThreads(maxThreads);
    serverArgs.workerThreads(maxThreads);
    TServer thriftServer = new TThreadedSelectorServer(serverArgs);
    thriftServer.serve();
  }
}