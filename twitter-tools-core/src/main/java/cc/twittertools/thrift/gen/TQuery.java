...
public class TQuery implements org.apache.thrift.TBase<TQuery, TQuery._Fields>, java.io.Serializable, Cloneable, Comparable<TQuery> {
  ...
  public int hashCode() {
    ...
    boolean present_max_id = true;
    list.add(present_max_id);
    if (present_max_id)
      list.add(max_id);

    boolean present_num_results = true;
  ...
  public int compareTo(TQuery other) {
    ...
    lastComparison = Boolean.valueOf(isSetMax_id()).compareTo(other.isSetMax_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMax_id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.max_id, other.max_id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
