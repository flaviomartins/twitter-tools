...
public class TResult implements org.apache.thrift.TBase<TResult, TResult._Fields>, java.io.Serializable, Cloneable, Comparable<TResult> {
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case FOLLOWERS_COUNT:
      return getFollowers_count();

    case STATUSES_COUNT:
      return getStatuses_count();

    case LANG:
      return getLang();

    case IN_REPLY_TO_STATUS_ID:
      return getIn_reply_to_status_id();

    case IN_REPLY_TO_USER_ID:
      return getIn_reply_to_user_id();

    case RETWEETED_STATUS_ID:
      return getRetweeted_status_id();

    case RETWEETED_USER_ID:
      return getRetweeted_user_id();

    case RETWEETED_COUNT:
      return getRetweeted_count();
  ...
  public int hashCode() {
    ...
    boolean present_rsv = true;
    list.add(present_rsv);
    if (present_rsv)
      list.add(rsv);

    boolean present_screen_name = true && (isSetScreen_name());
    list.add(present_screen_name);
    if (present_screen_name)
    ...
    boolean present_followers_count = true;
    list.add(present_followers_count);
    if (present_followers_count)
      list.add(followers_count);

    boolean present_statuses_count = true;
    list.add(present_statuses_count);
    if (present_statuses_count)
      list.add(statuses_count);
    ...
    boolean present_in_reply_to_status_id = true;
    list.add(present_in_reply_to_status_id);
    if (present_in_reply_to_status_id)
      list.add(in_reply_to_status_id);

    boolean present_in_reply_to_user_id = true;
    list.add(present_in_reply_to_user_id);
    if (present_in_reply_to_user_id)
      list.add(in_reply_to_user_id);

    boolean present_retweeted_status_id = true;
    list.add(present_retweeted_status_id);
    if (present_retweeted_status_id)
      list.add(retweeted_status_id);

    boolean present_retweeted_user_id = true;
    list.add(present_retweeted_user_id);
    if (present_retweeted_user_id)
      list.add(retweeted_user_id);

    boolean present_retweeted_count = true;
    list.add(present_retweeted_count);
    if (present_retweeted_count)
      list.add(retweeted_count);
  ...
  public int compareTo(TResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetRsv()).compareTo(other.isSetRsv());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRsv()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.rsv, other.rsv);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetFollowers_count()).compareTo(other.isSetFollowers_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFollowers_count()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.followers_count, other.followers_count);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetStatuses_count()).compareTo(other.isSetStatuses_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStatuses_count()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.statuses_count, other.statuses_count);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetIn_reply_to_status_id()).compareTo(other.isSetIn_reply_to_status_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIn_reply_to_status_id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.in_reply_to_status_id, other.in_reply_to_status_id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetIn_reply_to_user_id()).compareTo(other.isSetIn_reply_to_user_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIn_reply_to_user_id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.in_reply_to_user_id, other.in_reply_to_user_id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRetweeted_status_id()).compareTo(other.isSetRetweeted_status_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRetweeted_status_id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.retweeted_status_id, other.retweeted_status_id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRetweeted_user_id()).compareTo(other.isSetRetweeted_user_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRetweeted_user_id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.retweeted_user_id, other.retweeted_user_id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRetweeted_count()).compareTo(other.isSetRetweeted_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRetweeted_count()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.retweeted_count, other.retweeted_count);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
